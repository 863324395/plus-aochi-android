...
public class ApiConfig {
    ...
    public static final String APP_DOMAIN_FORMAL = "http://192.168.2.32/";// 正式服务器
    public static final String APP_DOMAIN_FOR_TEARCHER_QIAO = "http://192.168.2.32/";// 乔老师本地服务器
