...
public class ApiConfig {
    ...
    public static final String APP_DOMAIN_DEV = "http://192.168.2.24/";// 模拟在线正式服务器
    ...
    public static final String APP_DOMAIN_FOR_TEARCHER_QIAO = "http://192.168.2.24/";// 乔老师本地服务器
